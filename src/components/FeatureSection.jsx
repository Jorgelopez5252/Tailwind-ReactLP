...
const FeatureSection = () => {
  return (
    <div id="feature" className="relative mt-20 border-b border-neutral-800 min-h-200">
      {/* Section header container */}
      <div className="text-center">
        <span href="feature" className="bg-neutral-900 text-orange-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase">
          features
        </span>
